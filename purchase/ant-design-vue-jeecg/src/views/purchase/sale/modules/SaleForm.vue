  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
             <a-col :md="14" :sm="16">
           <a-form-item label="客户店名">
                    <a-select  name="projectNameList" v-decorator="['customerId']" placeholder="请选择客户" >
          ...
          <a-col :md="14" :sm="16">
           <a-form-item label="产品名称">
                    <a-select  name="projectNameList" v-decorator="['productId']" placeholder="请选择产品" >
                        <a-select-option value="">请选择</a-select-option>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'productName','productId','company','unitPrice','account','totalPrice','customerId','customerName'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'productName','productId','company','unitPrice','account','totalPrice','customerId','customerName'))
      },
    }
  }
</script>