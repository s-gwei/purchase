<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus">新增使用记录</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/purchase/stock/list",
          delete: "/purchase/stock/delete",
          deleteBatch: "/purchase/stock/deleteBatch",
          exportXlsUrl: "/purchase/stock/exportXls",
          importExcelUrl: "purchase/stock/importExcel",
