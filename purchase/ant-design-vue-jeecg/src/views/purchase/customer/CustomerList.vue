...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/purchase/customer/delete",
          deleteBatch: "/purchase/customer/deleteBatch",
          exportXlsUrl: "/purchase/customer/exportXls",
          importExcelUrl: "purchase/customer/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'shopName',text:'店名',dictCode:''})
