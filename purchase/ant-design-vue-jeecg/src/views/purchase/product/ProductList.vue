...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/purchase/product/delete",
          deleteBatch: "/purchase/product/deleteBatch",
          exportXlsUrl: "/purchase/product/exportXls",
          importExcelUrl: "purchase/product/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'name',text:'产品名称',dictCode:''})
